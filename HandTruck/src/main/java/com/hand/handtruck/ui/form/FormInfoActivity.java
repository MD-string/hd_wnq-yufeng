...
public class FormInfoActivity extends Activity implements View.OnClickListener {
    ...
    public  static void start(Context context, FormBean bean){
        Intent i=new Intent(context, FormInfoActivity.class);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ConstantsCode.MSG_WEI_LAN_SUCCESS:
                    ...
                    doHaveLat(wBean);
                    DLog.e("FormInfoActivity","围栏size==>"+wBean.size());
                    break;
                //获取车辆实时及最后状态失败
    ...
    protected void findViews() {
        ...
        rl_content_more=(RelativeLayout)findViewById(R.id.rl_content_more);
        rl_content_more.setVisibility(View.GONE);
        rl_fu_ceng=(RelativeLayout)findViewById(R.id.rl_fu_ceng);
        img_go_more=(ImageView)findViewById(R.id.img_go_more);
        ...
        img_go_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!isClick){
                    rl_content_more.setVisibility(View.VISIBLE);
        ...
        tv_order_carnuber=(TextView)findViewById(R.id.tv_order_carnuber);
        tv_order_carnuber.setText(bean.getCarNumber());
        tv_ji_tuan=(TextView)findViewById(R.id.tv_ji_tuan);
        tv_ji_tuan.setText(bean.getFactoryName());
        tv_order_number=(TextView)findViewById(R.id.tv_order_number);
        tv_order_number.setText(bean.getOrderCode());
        tv_pake_type=(TextView)findViewById(R.id.tv_pake_type);
        tv_pake_type.setText(bean.getProdName()+"");
        tv_pake_weight=(TextView)findViewById(R.id.tv_pake_weight);
        tv_pake_weight.setText(bean.getSendWeight()+"吨");
        tv_order_status=(TextView)findViewById(R.id.tv_order_status);
        tv_out_date=(TextView)findViewById(R.id.tv_out_date);
        tv_out_date.setText(bean.getLeaveTime()+"");
        ...
        tv_out_address=(TextView)findViewById(R.id.tv_out_address);
        ...
        final String status=bean.getRailCheckStatus();//订单状态  0-未审核  1-正常卸货  2异常卸货 3设备异常 4数据异常 5,未配置围栏
        initHeaderContent(status);
    }

    public void  initHeaderContent(String status){
        if ("0".equals(status)){ //
            tv_order_status.setText("运输中");
            tv_order_status.setTextColor(mContext.getResources().getColor(R.color.gh_blue));
            tv_order_carnuber.setBackground(mContext.getResources().getDrawable(R.drawable.shape_form_blue));
        }else if("2".equals(status)) {
            tv_order_status.setText("异常卸货");
            tv_order_status.setTextColor(mContext.getResources().getColor(R.color.gh_red));
            tv_order_carnuber.setBackground(mContext.getResources().getDrawable(R.drawable.shape_form_red));
        }else if("3".equals(status)){
            tv_order_status.setText("正常卸货");
            tv_order_status.setTextColor(mContext.getResources().getColor(R.color.gh_green));
            tv_order_carnuber.setBackground(mContext.getResources().getDrawable(R.drawable.shape_form_green));
        }else if("4".equals(status)){
            tv_order_status.setText("正常卸货");
            tv_order_status.setTextColor(mContext.getResources().getColor(R.color.gh_green));
            tv_order_carnuber.setBackground(mContext.getResources().getDrawable(R.drawable.shape_form_green));
        }else if("5".equals(status)){
            tv_order_status.setText("未配围栏");
            tv_order_status.setTextColor(mContext.getResources().getColor(R.color.gh_yellow));
            tv_order_carnuber.setBackground(mContext.getResources().getDrawable(R.drawable.shape_form_yellow));
        }
        else {
            tv_order_status.setText("正常卸货");
            tv_order_status.setTextColor(mContext.getResources().getColor(R.color.gh_green));
