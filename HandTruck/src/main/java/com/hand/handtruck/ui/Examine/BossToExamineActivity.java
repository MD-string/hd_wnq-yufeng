 ...
 * 2018-12-3
 * */
public class BossToExamineActivity extends FragmentActivity implements View.OnClickListener {
    ...
    public static void start(Context context, FormBean bean){
        Intent i=new Intent(context, BossToExamineActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_piclead);
        context =this;
        //透明状态栏
        CommonKitUtil.windowTranslucentStatus(BossToExamineActivity.this);
    ...
    protected void findViews() {
        mContext = BossToExamineActivity.this;
        ...
        tv_tab_2.setText("总经理审核");
        img_1=(ImageView)findViewById(R.id.img_1);
        img_2=(ImageView)findViewById(R.id.img_2);
        img_2.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.order_check_manager));
    ...
    protected void inIt() {
        ...
        BossExamineFragment bossFrgment=new BossExamineFragment();
        Bundle bundle1 = new Bundle();
        /*往bundle中添加数据*/
        bundle1.putSerializable("formBean", (Serializable)formBean);
        /*把数据设置到Fragment中*/
        bossFrgment.setArguments(bundle1);

        mFragmentList.add(moreFrg);  //订单详情
        mFragmentList.add(bossFrgment);  //取证处理
...
//                switchBorderTab(position);
                ...
                switch (position) {
                    ...
                    case 1:
                        ...
                        img_2.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.order_check_manager_white));
