...
public class TransportDuanDianAdapter extends BaseAdapter {
    private Context mContext;
    private List<TransportBean> mList;

    public TransportDuanDianAdapter(Context mContext, List<TransportBean> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new ViewHold();
            convertView = LayoutInflater.from(context).inflate(R.layout.item_transport_duandian, null);
